...
import {
  Bot, Plug, Menu, Plus, Zap, ChevronRight, BookOpen, Puzzle, CodeSquare, StopCircle, Loader2, HelpCircle, User, Users, Code, Star, Package, Sparkle, Sparkles, X, MessageCircle, PanelLeftOpen, Settings, LogOut, CreditCard, Key, Shield, DollarSign, KeyRound, Sun, Moon, Book, Database, PanelLeftClose
} from 'lucide-react';
