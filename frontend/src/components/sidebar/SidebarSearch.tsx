      ...
      <div className="relative">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-md bg-sidebar-muted py-2 pl-8 pr-10 text-sm
                     text-sidebar-foreground focus:outline-none focus:ring-1
                     focus:ring-sidebar-foreground/30"
          />
          {query && (
            <button
              onClick={clearQuery}
