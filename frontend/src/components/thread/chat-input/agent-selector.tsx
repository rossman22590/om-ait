...
export const AgentSelector: React.FC<AgentSelectorProps> = ({
  ...
  const allAgents = [
    {
      ...
      icon: <Image src="/logo.png" alt="Machine" width={16} height={16} className="h-4 w-4 dark:invert" />
    },
  ...
  const getAgentDisplay = () => {
    ...
    if (selectedAgentId !== undefined) {
      console.warn('Agent with ID', selectedAgentId, 'not found, falling back to Machine');
    }
    
    // Default to Machine (the first agent which has id: undefined)
