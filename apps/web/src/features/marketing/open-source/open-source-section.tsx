...
export function OpenSourceSection(): ReactNode {
  const content = useLocalizedUiCatalog(openSource);
  return (
    <div className="relative w-full overflow-hidden py-12 sm:py-14">
      ...
      >
        <Reveal className="relative mr-auto flex w-full max-w-xl min-w-0 flex-col items-start">
          <StarCount caption={content.stars.caption} />
