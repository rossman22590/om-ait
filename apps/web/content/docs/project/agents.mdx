...
An agent acts as itself: its Kortix permissions within its ceiling role,
whoever runs it. Starting a session does not lend the agent your own role.
See [Agent permissions](/docs/project/permissions).
