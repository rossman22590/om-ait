...
Manage connections in **Preferences → My providers**. Choose a connection in each provider row under **Project → Models → Providers**. Select **My connection**, **My API key**, or **My ChatGPT subscription** to use your credentials. Select **Project connection** to return to shared project credentials. Switching scope preserves the personal connection for other projects. Tokens remain on the API and never enter sandbox environment variables.
