...
Manage connections in **Preferences → My providers**. Enable an existing connection in **Project → Models → Providers → My providers**. Tokens remain on the API and never enter sandbox environment variables.
