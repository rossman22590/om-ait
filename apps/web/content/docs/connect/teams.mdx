...
The agent can ask with a real form rather than prose: a card with text boxes,
dropdowns, toggles and a Submit button, like asking in the Kortix app. You fill
it in, press Submit, and the answers arrive back as your next message in the
conversation. The agent posts one with `teams ask --form-file`.
