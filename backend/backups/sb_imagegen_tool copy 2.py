        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                ...
                try:
                    ...
                    image_display = f"![Generated Image](/workspace/images/{filename})"
                    ...
                    # Match the exact format shown in the successful example
                    # The specific output format is "Image successfully generated and saved to: /workspace/images/filename.png"
                    image_rel_path = f"/workspace/images/{filename}"
                    
                    # Return success with the exact format shown in the working example
                    return ToolResult(
                        success=True,
                        output=f"Image successfully generated and saved to: {image_rel_path}\n\n![Generated Image]({image_rel_path}){usage_info}"
                    )
