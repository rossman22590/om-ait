...
CREATE INDEX IF NOT EXISTS idx_user_presence_sessions_account_id ON user_presence_sessions(account_id);
CREATE INDEX IF NOT EXISTS idx_user_presence_sessions_thread_id ON user_presence_sessions(active_thread_id);
CREATE INDEX IF NOT EXISTS idx_user_presence_sessions_last_seen ON user_presence_sessions(last_seen);
CREATE INDEX IF NOT EXISTS idx_user_presence_sessions_account_thread ON user_presence_sessions(account_id, active_thread_id);
