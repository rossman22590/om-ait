...
class EmailService:
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Machine — Let's Get Started "
...
<body>
  <div class="container">
    ...
    <p>— The Machine Team</p>

    <a href="https://myapps.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Machine — we're excited to have you on board!



Let us know if you need help getting started or have questions.

For your business: if you want to automate manual and ordinary tasks for your company, book a call with us.

Thanks again, and welcome to the Machine community 🤖

— The Machine Team

Go to the platform: https://myapps.ai/

---
© 2024 Machine. All rights reserved.
You received this email because you signed up for a Machine account."""
