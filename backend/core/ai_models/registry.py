...
# Force use of direct Anthropic API (not Bedrock)
# We don't use AWS Bedrock - always use direct Anthropic
# HARDCODED - NO CONDITIONALS - PYTHON MODULE CACHING CAUSES ISSUES
_BASIC_MODEL_ID = "anthropic/claude-sonnet-4-5-20250929"
