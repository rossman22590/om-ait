...
from core.agentpress.tool import Tool, ToolResult, openapi_schema, tool_metadata, usage_example
...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @usage_example('''
        ...
        <parameter name="query">what is Pixio AI and what are they building?</parameter>
