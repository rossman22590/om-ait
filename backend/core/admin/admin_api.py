...
from core.utils.auth_utils import verify_admin_api_key, verify_and_get_user_id_from_jwt
...
# ============================================================================
# FIX ACCOUNT ENDPOINT (Temporary - for accounts stuck during signup)
# ============================================================================

@router.post("/fix/grant-free-tier-credits")
async def grant_free_tier_credits_admin(account_id: str = Depends(verify_and_get_user_id_from_jwt)):
    """
    Manually grant free tier credits to an account.
    This is a temporary fix for accounts that got stuck during signup.
    Users can fix their own accounts by calling this endpoint.
    """
