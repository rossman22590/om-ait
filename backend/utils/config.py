...
class Configuration:
    ...
    OR_SITE_URL: Optional[str] = "https://beta-machinev5.vercel.app"
    OR_APP_NAME: Optional[str] = "Machine AI"    
    ...
    STRIPE_PRODUCT_ID_STAGING: str = 'prod_SGT7srmz5hB2qo'  # Staging product ID
