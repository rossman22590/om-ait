-- Migration: account_secret_project_access
--
...
ALTER TABLE "kortix"."account_secret_resources" ADD COLUMN "project_id" uuid;--> statement-breakpoint
ALTER TABLE "kortix"."account_secret_resources" ADD COLUMN "access_mode" varchar(16) DEFAULT 'members' NOT NULL;--> statement-breakpoint
ALTER TABLE "kortix"."account_secret_resources" ADD CONSTRAINT "account_secret_resources_project_id_projects_project_id_fk" FOREIGN KEY ("project_id") REFERENCES "kortix"."projects"("project_id") ON DELETE cascade ON UPDATE no action NOT VALID;
