...
CREATE TABLE "kortix"."account_scim_users" (
	...
	CONSTRAINT "account_scim_users_account_id_scim_id_pk" PRIMARY KEY("account_id","scim_id")
);
--> statement-breakpoint
ALTER TABLE "kortix"."account_scim_users" ADD CONSTRAINT "account_scim_users_account_id_accounts_account_id_fk" FOREIGN KEY ("account_id") REFERENCES "kortix"."accounts"("account_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "account_scim_users_account_email" ON "kortix"."account_scim_users" USING btree ("account_id","user_name");--> statement-breakpoint
CREATE INDEX "account_scim_users_account_user" ON "kortix"."account_scim_users" USING btree ("account_id","user_id");
ALTER TABLE kortix.account_scim_users ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON kortix.account_scim_users FROM anon, authenticated;
